...
class Bank:
    ...
    def get_interest_rate(self):
        if self.__type == "Savings Account":
            
            print(f"\nSince you have {self.__type}, your interest rate is {self.__interest_rate_Savings} \n Note** Interest is accrued every 5 mins.")
        else:
            print(f"\nSince you have {self.__type}, your interest rate is {self.__interest_rate_Fixed} \n Note** Interest is accrued every 5 mins.")
...
#Choice 1
    if user_choice == "1" and user==None:
        ...
        user_type=input("Which Bank Account type do you like to open? \n Press 1 for Savings Account. Press 2 for Fixed Account. ")
        if user_type == "1":
            user_type="Savings Account"
        if user_type == "2":
            user_type ="Fixed Account"
        ...
        print(f"\n You already have an account named {user_fn} {user_ln}. \n Please delete your current Account by presing 8 before creating a new account.")
#Choice 2
